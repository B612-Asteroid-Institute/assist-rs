...
fn load_pck(path: &Path) -> Result<Vec<Type2Segment>> {
    ...
    let summary_words = nd as usize + (ni as usize).div_ceil(2);
...
fn build_rotation(a1: f64, a2: f64, a3: f64) -> [[f64; 3]; 3] {
    ...
    let m_eclj_to_itrf = matmul3(&matmul3(&rot_z(-a3), &rot_x(-a2)), &rot_z(-a1));
...
mod tests {
    ...
    const REFERENCE_MATRICES: &[(f64, [[f64; 3]; 3])] = &[
        (
            ...
            [
                [
                    1.76980593920407242e-01,
                    -9.84214340916322761e-01,
                    -2.25882366727270245e-05,
                ],
                [
                    9.84214340853249436e-01,
                    1.76980593228519362e-01,
                    2.96527445451250093e-05,
                ],
                [
                    -2.51869769025144716e-05,
                    -2.74796268088239870e-05,
                    9.99999999305243081e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    -6.30643919962785349e-01,
                    7.76072320204723942e-01,
                    5.10181939461507028e-06,
                ],
                [
                    -7.76072319714293024e-01,
                    -6.30643919299331168e-01,
                    -4.02995604470435254e-05,
                ],
                [
                    -2.80579420008189413e-05,
                    -2.93740535854958296e-05,
                    9.99999999174958409e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    1.93884145136247354e-01,
                    -9.81024432810858049e-01,
                    -2.22018276302415885e-05,
                ],
                [
                    9.81024432746447350e-01,
                    1.93884144450126555e-01,
                    2.97548960264265583e-05,
                ],
                [
                    -2.48856976423294409e-05,
                    -2.75495379365442439e-05,
                    9.99999999310862586e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    5.14075082542250206e-01,
                    -8.57745188977827921e-01,
                    -1.71630107713705016e-05,
                ],
                [
                    8.57745189149325959e-01,
                    5.14075082453315679e-01,
                    9.58142343673862307e-06,
                ],
                [
                    6.04656321041702567e-07,
                    -1.96470609645782446e-05,
                    9.99999999806813755e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    -9.94874022034065053e-01,
                    -1.01121833051657423e-01,
                    2.34865994768539144e-04,
                ],
                [
                    1.01121833890863072e-01,
                    -9.94874049637020752e-01,
                    -8.32967580344234904e-06,
                ],
                [
                    2.34504395423373261e-04,
                    1.54631020408135811e-05,
                    9.99999972384290059e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    -6.10321136736908021e-01,
                    7.92154080234992897e-01,
                    1.52378544191200671e-04,
                ],
                [
                    -7.92154045927301431e-01,
                    -6.10321155354273892e-01,
                    2.34196564775329685e-04,
                ],
                [
                    2.78519613505794257e-04,
                    2.22278333399383854e-05,
                    9.99999960966373336e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    -5.40465715167075533e-01,
                    -8.41365666675846113e-01,
                    7.90991814210717514e-04,
                ],
                [
                    8.41364633946004137e-01,
                    -5.40466291909377339e-01,
                    -1.31911130469442028e-03,
                ],
                [
                    1.53735937505101940e-03,
                    -4.74218964589545600e-05,
                    9.99998817137958129e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    -9.86134927339477052e-01,
                    -1.65928105443120949e-01,
                    2.40185453777035790e-03,
                ],
                [
                    1.65927694454056252e-01,
                    -9.86137851794280262e-01,
                    -3.70771794214408423e-04,
                ],
                [
                    2.43008113556495006e-03,
                    3.29031695190939999e-05,
                    9.99997046807167278e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    -7.60910330896355958e-01,
                    6.48854406998714550e-01,
                    1.85117625969774546e-03,
                ],
                [
                    -6.48852373067780652e-01,
                    -7.60912581883302686e-01,
                    1.62502184476126521e-03,
                ],
                [
                    2.46298589273021918e-03,
                    3.53558005394827291e-05,
                    9.99996966220627947e-01,
                ],
            ],
        ),
    ];
    ...
    const HISTORICAL_REFERENCE: &[(f64, [[f64; 3]; 3])] = &[
        (
            ...
            [
                [
                    9.94364553444000543e-01,
                    1.05970302576597813e-01,
                    3.07080216520302929e-03,
                ],
                [
                    -1.05969692207008692e-01,
                    9.94369294492217670e-01,
                    -3.61254206012628920e-04,
                ],
                [
                    -3.09179360005633732e-03,
                    3.38064169663754299e-05,
                    9.99995219823305304e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    7.99970199503151957e-01,
                    -6.00038405624525262e-01,
                    1.26161898562854313e-03,
                ],
                [
                    6.00037686369575995e-01,
                    7.99971194223579762e-01,
                    9.29165618249683245e-04,
                ],
                [
                    -1.56679390272404951e-03,
                    1.37141322137379618e-05,
                    9.99998772483641107e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    2.96054724022567550e-01,
                    9.55170970204011538e-01,
                    1.34400329954154074e-04,
                ],
                [
                    -9.55170930067680501e-01,
                    2.96054751062657939e-01,
                    -2.80583088907757072e-04,
                ],
                [
                    -3.07794677482192702e-04,
                    -4.53073392118197305e-05,
                    9.99999951604839565e-01,
                ],
            ],
        ),
    ];
    ...
    const PREDICT_REFERENCE: &[(f64, [[f64; 3]; 3])] = &[
        (
            ...
            [
                [
                    -9.68628820561433290e-01,
                    -2.48493871286336765e-01,
                    3.00065174523937717e-03,
                ],
                [
                    2.48492558544244874e-01,
                    -9.68633467582096008e-01,
                    -8.08596326593691295e-04,
                ],
                [
                    3.10746293650065878e-03,
                    -3.75900766640402395e-05,
                    9.99995171118883142e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    -3.19030968337769172e-01,
                    9.47742239093496308e-01,
                    1.97217633886831445e-03,
                ],
                [
                    -9.47724230103578091e-01,
                    -3.19037064009499882e-01,
                    5.84255618531083487e-03,
                ],
                [
                    6.16643462995759405e-03,
                    -5.12294501492371879e-06,
                    9.99980987348114470e-01,
                ],
            ],
        ),
        (
            ...
            [
                [
                    9.39214248749958514e-01,
                    -3.43181457839852599e-01,
                    -1.01529276548461694e-02,
                ],
                [
                    3.43163334530398545e-01,
                    9.39269108836152888e-01,
                    -3.53086676571068292e-03,
                ],
                [
                    1.07480593145401586e-02,
                    -1.67872132489699233e-04,
                    9.99942223850917467e-01,
                ],
            ],
        ),
    ];
